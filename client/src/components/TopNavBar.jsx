...
import { FaShoppingCart, FaRegUserCircle, FaChevronDown, FaChevronUp } from "react-icons/fa";
                ...
                <div className="flex items-center space-x-4">
                    {user ? (
                        <>
                            ...
                            <Link 
                            to="/wishlist"
                            className="flex items-center gap-1 px-3 py-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md"
                            >
